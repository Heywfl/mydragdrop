...
var _columns = require('./styles/columns');
...
(0, _insertCss2.default)(_csjs2.default.getCss(_columns2.default), { prepend: true });

var Columns = exports.Columns = function (_Component) {
  ...
  _createClass(Columns, [{
    ...
    value: function createClassName() {
      return [_columns2.default.columns, _columns2.default[(0, _lodash2.default)(this.props.responsive)], this.props.isMultiline ? _columns2.default['is-multiline'] : '', this.props.isGapless ? _columns2.default['is-gapless'] : '', this.props.className].join(' ').trim();
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: this.createClassName(), style: this.props.customStyle },
        this.props.children
      );
    }
  }]);
...
var Column = exports.Column = function (_Component2) {
  ...
  _createClass(Column, [{
    key: 'createClassName',
    value: function createClassName() {
      return [_columns2.default.column, _columns2.default[(0, _lodash2.default)(this.props.size)], _columns2.default[(0, _lodash2.default)(this.props.offset)], this.props.className].join(' ').trim();
    }
  }, {
    key: 'render',
    value: function render() {
