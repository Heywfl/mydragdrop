...
var Select = function (_Component) {
  ...
  _createClass(Select, [{
    ...
    value: function createControlClassName() {
      return [_form2.default.control, _form2.default[(0, _lodash2.default)(this.props.state)], this.props.className].join(' ').trim();
    }
  }, {
    key: 'createSelectClassName',
    value: function createSelectClassName() {
      return [_form2.default.select, _form2.default[(0, _lodash2.default)(this.props.size)]].join(' ').trim();
    }
  }, {
    key: 'renderHelp',
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'span',
          { className: this.createSelectClassName() },
          _react2.default.createElement(
            'select',
            {
