...
(0, _insertCss2.default)(_csjs2.default.getCss(_table2.default), { prepend: true });
...
var Table = exports.Table = function (_Component) {
  ...
  _createClass(Table, [{
    ...
    value: function createClassName() {
      return [_table2.default.table, this.props.isBordered ? _table2.default['is-bordered'] : '', this.props.isStriped ? _table2.default['is-striped'] : '', this.props.isNarrow ? _table2.default['is-narrow'] : '', this.props.className].join(' ').trim();
    }
  }, {
    key: 'render',
...
var Td = exports.Td = function (_Component2) {
  ...
  _createClass(Td, [{
    key: 'createClassName',
    value: function createClassName() {
      return [_table2.default.td, this.props.isIcon ? _table2.default['is-icon'] : '', this.props.className].join(' ').trim();
    }
  }, {
    key: 'render',
    value: function render() {
...
var Th = exports.Th = function (_Component3) {
  ...
  _createClass(Th, [{
    key: 'createClassName',
    value: function createClassName() {
      return [_table2.default.th, this.props.className].join(' ').trim();
    }
  }, {
    key: 'render',
    value: function render() {
...
var Tr = exports.Tr = function (_Component4) {
  ...
  _createClass(Tr, [{
    key: 'createClassName',
    value: function createClassName() {
      return [_table2.default.tr, this.props.className].join(' ').trim();
    }
  }, {
    key: 'render',
    value: function render() {
